...
public class TCFPublicAPI {
	...
	private void initCart(String host, String port) {
		...
		String address = "http://" + host + ":" + port + "/webservicesmodule-1.0-SNAPSHOT/webservices/webservicesmodule-1.0-SNAPSHOT/CartWS";
	...
	private void initCCS(String host, String port) {
		...
		String address = "http://" + host + ":" + port + "/webservicesmodule-1.0-SNAPSHOT/webservices/webservicesmodule-1.0-SNAPSHOT/CustomerCareWS";
